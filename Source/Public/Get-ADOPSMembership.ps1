function Get-ADOPSMembership {
    param ([Parameter()]
        ...
        [Parameter(Mandatory)]
        [string]
        $Descriptor = 'vssgp.Uy0xLTktMTU1MTM3NDI0NS0zNjE3OTkwMTAxLTE2NDMyOTI3NDItMjI3NTA1MDMxMi0zNDgyOTQ1MDkzLTAtMC0wLTAtMQ',
    ...
    # Satt direction och depth, Hämtar alla som är medlemmar i gruppen.
